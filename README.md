...
Status: design settled; the crate skeleton is in place, with `serve`, `new` and `list` working. See [CONTEXT.md](CONTEXT.md) for the vocabulary, [docs/adr](docs/adr) for the load-bearing decisions, and [docs/v1-scope.md](docs/v1-scope.md) for what v1 is and is not.
